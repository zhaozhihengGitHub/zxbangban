            ...
            <div class="comment-show-con-list pull-left clearfix">
                ...
                <div class="date-dz">
                    ...
                    <div class="date-dz-right pull-right comment-pl-block">
                        ...
                        <a href="javascript:;" class="date-dz-z pull-left"><i class="date-dz-z-click-red"></i>赞 (<i class="z-num">2</i>)</a>
                    </div>
                </div>
...
//        var oSize = $(this).siblings('.flex-text-wrap').find('.comment-input').val();
        ...
        console.log(oSize);
        //动态创建评论模块
        oHtml = '<div class="comment-show-con clearfix"><div class="comment-show-con-img pull-left"><img src="${pageContext.request.contextPath}/resources/images/header-img-comment_03.png" alt=""></div> <div class="comment-show-con-list pull-left clearfix"><div class="pl-text clearfix"> <a href="#" class="comment-size-name">David Beckham : </a> <span class="my-pl-con">&nbsp;'+ oSize +'</span> </div> <div class="date-dz"> <span class="date-dz-left pull-left comment-time">'+now+'</span> <div class="date-dz-right pull-right comment-pl-block"><a href="javascript:;" class="removeBlock">删除</a> <a href="javascript:;" class="date-dz-pl pl-hf hf-con-block pull-left">回复</a> <span class="pull-left date-dz-line">|</span> <a href="javascript:;" class="date-dz-z pull-left"><i class="date-dz-z-click-red"></i>赞 (<i class="z-num">2</i>)</a> </div> </div><div class="hf-list-con"></div></div> </div>';
...
<script type="text/javascript">
    $('.comment-show').on('click','.hf-pl',function(){
        ...
        if(oHfVal.replace(/^ +| +$/g,'') == '' || oHfVal == oAllVal){
            ...
            $.getJSON("${pageContext.request.contextPath}/resources/js/pl.json",function(data){
                var oAt = '';
                var oHf = '';
