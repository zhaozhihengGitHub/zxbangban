        ...
        init: function () {
            ...
            if ($cookie !== undefined) {
                ...
                $navLogin.append("<li>\n" +
                    ...
                    "\t\t\t\t\t<img src=\"https://zxbangban.oss-cn-beijing.aliyuncs.com/header/QR_2.jpg\" alt=\"\" />\n" +
                    "\t\t\t\t</li>");
            }
        },
        animate: function () {
        ...
        check: function () {
            ...
            function valiTel() {
                ...
                if (!($telRegular.test($temp))) {
                    ...
                    $telChChe = $temp;
                    $.ajax({
                        url: "/account/validateTel",
                        data:{"tel":$temp},
                        type:"GET",
                        success: function (data) {
                            if(data == 1){
                                $tel.val("");
                                $tel.attr("placeholder", errorInfo.THE_CELL_PHONE_NUMBER_IS_SIGNUP);
                                return false;
                            }else{
                                return true;
                            }
            ...
            var errorInfo = {
                ...
                THE_CELL_PHONE_NUMBER_IS_SIGNUP: "手机号码已注册！",
